...
<template>
  <div>
    <Row :gutter="10">
            <Col>
                <Card>
                    ...
                    <Row>
                        <Input v-model="search" icon="search" @on-change="getGoods" placeholder="请输入标题搜索..." style="width: 400px" />
    ...
    <Modal v-model="divModal" title="文章详情" width="900" @on-ok="saveGoods()" ok-text="保存" style="top:20px" >
